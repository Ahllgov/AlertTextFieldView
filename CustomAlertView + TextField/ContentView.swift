...
struct ContentView: View {
    var body: some View {
        Button("Present Alert") {
            alertTF(title: "Login", message: "Please enter your password for @Ahllgov", hintText: "12345", primaryTitle: "Login", secondaryTitle: "Cancel", primaryAction: { text in
                print(text)
            }, secondaryAction: {
                print("Cancelled")
            })
